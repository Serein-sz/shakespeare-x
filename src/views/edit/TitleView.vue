...
function activeTitle(event, element: HTMLElement) {
...
<template>
  <nav>
    <div v-if="store.titleElements && store.titleElements.length > 0" class="relative pl-4">
      ...
      <div v-for="item in store.titleElements" :key="item" @click="event => activeTitle(event, item)"
